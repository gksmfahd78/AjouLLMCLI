...
const { readTextFile, writeWorkspaceFile, listProjectFiles, matchGlob, runShellCommand, safeCommand } = require("./workspace");
const { requestJson, createHeaders, runChatOnce, buildInternalReviewFromMessages, FINAL_REASONING_PROMPT } = require("./api");
const { getContextSnippets } = require("./context");
...
module.exports = {
  ...
  buildAgentEdits, applyAgentEdits
};
