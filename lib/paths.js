...
const UTILITY_MODEL = "gpt-5-nano";
...
const CONFIG_KEYS = ["apiKey", "model", "baseUrl", "systemPrompt", "temperature", "topP", "maxTokens", "stream"];
...
module.exports = {
  ...
  CONFIG_KEYS, KNOWN_COMMANDS, TEXT_FILE_EXTENSIONS, PROJECT_FILE_CACHE_TTL_MS, SLASH_COMMANDS
};
